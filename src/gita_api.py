...
4. Return the IDs ranked from Best to Worst inside a JSON object.
    ...
    def _is_relevant_to_krishna(self, query: str) -> Tuple[bool, str]:
        ...
        irrelevant_patterns = {
            'japanese': ['野球', 'サッカー', 'テニス', '相撲', '五輪', 'オリンピック', 'メダル', 'リーグ', 'トーナメント',
                         '政治', '選挙', 'ニュース', '首相', '大統領', '政府', '予算', '裁判所',
                         'アニメ', 'マンガ', '漫画', '映画', '俳優', '女優', 'タレント', '芸能人', 'アイドル', 'YouTube', '動画', 'ドラマ',
                         'パソコン', 'スマホ', 'プログラミング', 'コード', 'エラー', 'バグ', 'アプリ', 'インストール', 'ダウンロード',
                         '投資', '株', 'FX', '仮想通貨', 'ビットコイン', '銀行', '給料', '稼ぐ', 'クーポン', 'セール', '割引',
                         'レシピ', '料理', '作り方', 'ごはん', 'パスタ', 'ピザ', 'ラーメン', '弁当', '朝食', '夕食', '注文',
                         '天気', '気温', '雨', '予報', '切符', 'ホテル', '予約', 'パスポート', '空港', '駅'],
            # Sports & Games
